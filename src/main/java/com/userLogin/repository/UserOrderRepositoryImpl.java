...
import com.userLogin.repository.mapper.UserOrderMapper;
...
public class UserOrderRepositoryImpl implements UserOrderRepository {
    ...
    public void updateOrderById(Long orderId,UserOrder userOrder) {
        ...
        jdbcTemplate.update(sql,userOrder.getUsername(),userOrder.getOrderDate(),userOrder.getTotalPrice(),userOrder.getShippingAddress(),userOrder.getOrderStatus(),orderId);
