...
import com.userLogin.repository.mapper.OrderListMapper;
...
public class OrderListRepositoryImpl implements OrderListRepository{
    ...
    public void createOrderList(OrderList orderList) {
        String sql = "INSERT INTO " + ORDER_LIST_TABLE_NAME + " (username,item_id,quantity_of_item) VALUES (?,?,?)";
        jdbcTemplate.update(sql,orderList.getUsername(),orderList.getItemId(),orderList.getQuantityOfItem());
    }
